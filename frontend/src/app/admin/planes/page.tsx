/**
 * Admin Plans Configuration Page
 */
...
import { PlanConfigCard } from '@/components/features/admin/PlanConfigCard';
import { PlanComparisonTable } from '@/components/features/admin/PlanComparisonTable';
