/**
 * Página Principal de Carta Astral
 *
 * Página de entrada para generar una carta astral natal.
 * Muestra formulario de datos de nacimiento, estado de uso según plan,
 * y maneja la navegación al resultado.
 */
