...
/**
 * Página de Historial de Cartas Astrales
...
export default function HistorialPage() {
  ...
  // Hooks API
  const { data: historyData, isLoading, error } = useChartHistory(page, limit);
  ...
  }, [selectedChart, newName, renameChart, toast]);
  ...
  if (!isPremium) {
    return (
      <div data-testid="historial-page" className="container mx-auto max-w-7xl p-6">
