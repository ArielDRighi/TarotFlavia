...
export interface AboutPageData {
   ...
   *
   * La página afirma que el contenido se revisa periódicamente; sin una fecha a
   * la vista, esa afirmación no la puede verificar nadie. Alimenta también el
...
export const ABOUT_PAGE: AboutPageData = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        'La enciclopedia es la parte más extensa del sitio: las 78 cartas del tarot, los doce signos, los planetas, las doce casas astrológicas y las guías prácticas de cada disciplina, más los perfiles de los doce animales del zodíaco chino. Todo ese material está escrito por nosotros, específicamente para Auguria. No hay texto copiado de otros sitios ni traducciones automáticas de manuales en inglés.',
        'Cada ficha parte de las fuentes clásicas de su disciplina —los significados tradicionales de la baraja, la simbología astrológica establecida, las tablas de la tradición china— y se contrasta con lo que la práctica de consulta muestra realmente. Donde la tradición no es unánime —y no lo es casi nunca— el texto describe la lectura más difundida sin presentarla como la única posible: la tradición no es un cuerpo homogéneo, y fingir que lo es sería inexacto.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Por eso la enciclopedia entera es de acceso libre, el horóscopo diario, la carta del día, la numerología y el péndulo funcionan sin suscripción, y las sesiones con tarotistas tienen su precio publicado en la ficha. El plan premium existe para sostener el proyecto y para quien quiera lecturas más extensas, pero el sitio tiene que servir aunque nunca pagues nada.',
      ],
    },
    {
      heading: 'Lo que no hacemos',
      paragraphs: [
        'Auguria ofrece orientación personal y entretenimiento, y eso no sustituye el asesoramiento de un profesional. No damos diagnósticos ni indicaciones sobre enfermedades, tratamientos o medicación; no damos consejo legal ni financiero. Cuando una consulta roza uno de esos terrenos, lo que devolvemos es una lectura simbólica de la situación y la recomendación de acudir a quien corresponda: el péndulo, por ejemplo, detecta las preguntas médicas y las frena antes de responder.',
        'Tampoco vendemos resultados. Ningún servicio del sitio se ofrece bajo la promesa de que alguien vuelva, de que un negocio prospere o de que una situación se resuelva en un plazo determinado, y no hay trabajos pagos que se comprometan a un desenlace. Cuando una carta se lee como favorable, eso describe una tendencia, no un contrato.',
  ...
  principlesHeading: 'Nuestros compromisos editoriales',
  ...
  principles: [
    ...
    {
      term: 'Tradición, no invención',
      description:
        'Los significados, las correspondencias y las tablas provienen de las fuentes clásicas de cada disciplina, no de generalizaciones armadas para llenar la página.',
    },
    {
      term: 'Sin promesas de resultados',
      description:
        'Ningún servicio se ofrece prometiendo un desenlace, un plazo ni la conducta de otra persona: lo que se entrega es una lectura de la situación y de sus tendencias.',
    },
    {
      term: 'Límites explícitos',
      description:
        'Los temas médicos quedan fuera de lo que interpretamos, y el péndulo los frena antes de responder. Las cuestiones legales o económicas se leen como contexto de una situación, nunca como asesoramiento.',
    },
    {
