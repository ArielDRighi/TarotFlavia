...
/**
 * Hub del horóscopo chino: calculadora, tarjeta del usuario y selector de
 * animales. Vivía entero en `app/horoscopo-chino/page.tsx` (lógica en `app/`);
 * desde T-SEO-015 la ruta es un Server Component que lo renderiza y agrega la
 * nota de uso (`ChineseHoroscopeGuide`) debajo.
 */
export function ChineseHoroscopeHub() {
  const {
    currentYear,
    isAuthenticated,
    userBirthDate,
