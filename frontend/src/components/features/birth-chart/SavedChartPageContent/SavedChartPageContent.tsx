...
/**
 * SavedChartPageContent
 *
 * Feature component containing all logic for the Saved Chart detail page (Premium).
 * Extracted from app/carta-astral/resultado/[id]/page.tsx to comply with the architecture
