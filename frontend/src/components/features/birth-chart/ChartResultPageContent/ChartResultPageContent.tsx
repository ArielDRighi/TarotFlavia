...
/**
 * ChartResultPageContent
 *
 * Feature component containing all logic for the Carta Astral result page.
 * Extracted from app/carta-astral/resultado/page.tsx to comply with the architecture
 * rule that app/ pages must not contain business logic (useState, useEffect, hooks).
 */
...
export function ChartResultPageContent() {
