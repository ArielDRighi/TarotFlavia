/**
 * TarotistasManagementContent Component
 *
 * Main content component for tarotistas management page
 * Handles state and business logic for active tarotistas and pending applications
 */
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="activos">
          {tarotistasLoading ? (
            ...
            <>
              <TarotistasTable tarotistas={tarotistasData.data} onAction={handleTarotistaAction} />
