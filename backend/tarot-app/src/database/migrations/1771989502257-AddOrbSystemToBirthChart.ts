...
export class AddOrbSystemToBirthChart1771989502257 implements MigrationInterface {
  name = 'AddOrbSystemToBirthChart1771989502257';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "birth_charts" ADD "orbSystem" character varying(20) NOT NULL DEFAULT 'commercial'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."usage_limit_feature_enum" AS ENUM('daily_card', 'tarot_reading', 'oracle_query', 'interpretation_regeneration', 'pendulum_query', 'birth_chart')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."idx_interpretation_planet_sign"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."idx_interpretation_planet_house"`,
    );
    await queryRunner.query(`DROP INDEX "public"."idx_interpretation_aspect"`);
    await queryRunner.query(
      `ALTER TABLE "birth_chart_interpretations" DROP CONSTRAINT "uq_interpretation_combo"`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."interpretation_category_enum" RENAME TO "interpretation_category_enum_old"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."birth_chart_interpretations_category_enum" AS ENUM('planet_intro', 'planet_in_sign', 'planet_in_house', 'aspect', 'ascendant')`,
    );
    await queryRunner.query(
      `ALTER TABLE "birth_chart_interpretations" ALTER COLUMN "category" TYPE "public"."birth_chart_interpretations_category_enum" USING "category"::"text"::"public"."birth_chart_interpretations_category_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."interpretation_category_enum_old"`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."planet_enum" RENAME TO "planet_enum_old"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."birth_chart_interpretations_planet_enum" AS ENUM('sun', 'moon', 'mercury', 'venus', 'mars', 'jupiter', 'saturn', 'uranus', 'neptune', 'pluto')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "birth_chart_interpretations" ALTER COLUMN "sign" TYPE "public"."birth_chart_interpretations_sign_enum" USING "sign"::"text"::"public"."birth_chart_interpretations_sign_enum"`,
    );
    await queryRunner.query(`DROP TYPE "public"."zodiac_sign_enum_old"`);
    await queryRunner.query(
      `ALTER TYPE "public"."aspect_type_enum" RENAME TO "aspect_type_enum_old"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."birth_chart_interpretations_aspecttype_enum" AS ENUM('conjunction', 'opposition', 'square', 'trine', 'sextile')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "birth_chart_interpretations" ALTER COLUMN "planet2" TYPE "public"."birth_chart_interpretations_planet2_enum" USING "planet2"::"text"::"public"."birth_chart_interpretations_planet2_enum"`,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."audit_logs_action_enum" AS ENUM('user_created', 'user_banned', 'user_unbanned', 'role_added', 'role_removed', 'plan_changed', 'reading_deleted', 'reading_restored', 'card_modified', 'spread_modified', 'config_changed', 'user_deleted', 'update_usage_limits')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "idx_birth_chart_user_birth" ON "birth_charts" ("userId", "birthDate", "birthTime", "latitude", "longitude", "orbSystem") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."audit_logs_action_enum_old" AS ENUM('card_modified', 'config_changed', 'plan_changed', 'reading_deleted', 'reading_restored', 'role_added', 'role_removed', 'spread_modified', 'user_banned', 'user_created', 'user_deleted', 'user_unbanned')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."planet_enum_old" AS ENUM('jupiter', 'mars', 'mercury', 'moon', 'neptune', 'pluto', 'saturn', 'sun', 'uranus', 'venus')`,
    );
    await queryRunner.query(
      `ALTER TABLE "birth_chart_interpretations" ALTER COLUMN "planet2" TYPE "public"."planet_enum_old" USING "planet2"::"text"::"public"."planet_enum_old"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."birth_chart_interpretations_planet2_enum"`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."planet_enum_old" RENAME TO "planet_enum"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."aspect_type_enum_old" AS ENUM('conjunction', 'opposition', 'sextile', 'square', 'trine')`,
    );
    await queryRunner.query(
      `ALTER TABLE "birth_chart_interpretations" ALTER COLUMN "aspectType" TYPE "public"."aspect_type_enum_old" USING "aspectType"::"text"::"public"."aspect_type_enum_old"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."birth_chart_interpretations_aspecttype_enum"`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."aspect_type_enum_old" RENAME TO "aspect_type_enum"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "birth_chart_interpretations" ALTER COLUMN "sign" TYPE "public"."zodiac_sign_enum_old" USING "sign"::"text"::"public"."zodiac_sign_enum_old"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."birth_chart_interpretations_sign_enum"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "birth_chart_interpretations" ALTER COLUMN "planet" TYPE "public"."planet_enum_old" USING "planet"::"text"::"public"."planet_enum_old"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."birth_chart_interpretations_planet_enum"`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."planet_enum_old" RENAME TO "planet_enum"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."interpretation_category_enum_old" AS ENUM('ascendant', 'aspect', 'planet_in_house', 'planet_in_sign', 'planet_intro')`,
    );
    await queryRunner.query(
      `ALTER TABLE "birth_chart_interpretations" ALTER COLUMN "category" TYPE "public"."interpretation_category_enum_old" USING "category"::"text"::"public"."interpretation_category_enum_old"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."birth_chart_interpretations_category_enum"`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."interpretation_category_enum_old" RENAME TO "interpretation_category_enum"`,
    );
    await queryRunner.query(
      `ALTER TABLE "birth_chart_interpretations" ADD CONSTRAINT "uq_interpretation_combo" UNIQUE ("category", "planet", "sign", "house", "aspectType", "planet2")`,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_interpretation_aspect" ON "birth_chart_interpretations" ("planet", "aspectType", "planet2") `,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_interpretation_planet_house" ON "birth_chart_interpretations" ("planet", "house") `,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."usage_feature_enum_old" AS ENUM('birth_chart', 'daily_card', 'interpretation_regeneration', 'oracle_query', 'pendulum_query', 'tarot_reading')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "birth_charts" DROP COLUMN "orbSystem"`,
    );
    await queryRunner.query(
