...
export class CreateSystemConfigTable1770944236254 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "system_config" ("id" SERIAL NOT NULL, "category" character varying(50) NOT NULL, "key" character varying(100) NOT NULL, "value" text NOT NULL, "description" character varying(255), "updatedBy" character varying(100), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "uq_system_config_category_key" UNIQUE ("category", "key"), CONSTRAINT "PK_db4e70ac0d27e588176e9bb44a0" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
