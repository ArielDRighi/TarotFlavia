...
export const MAJOR_ARCANA_DATA: CardSeedData[] = [
  ...
  },
  {
    ...
    meaningReversed:
      'En posición invertida, revela intuición bloqueada, secretos tóxicos, chismes o dependencia emocional. El bloqueo reside en ignorar deliberadamente tu voz interior por miedo a lo que pueda decir, o en desconectarte de tu feminidad sagrada. Para superarlo, debes alejarte del ruido exterior, enfrentar las verdades incómodas que tu subconsciente te muestra a través de sueños o ansiedades, y dejar de buscar validación en el mundo material para encontrarla en tu templo interno.',
    description:
  ...
  },
  {
    ...
    meaningUpright:
      'La Templanza encarna la alquimia interior, la moderación, el equilibrio dinámico, la paciencia y la reparación profunda. En el amor, indica una convivencia pacífica, compromiso, la mezcla perfecta de personalidades opuestas y el cierre de viejas heridas afectivas. En el trabajo, aconseja administración moderada, fusiones de negocios exitosas y un progreso lento pero sumamente sólido. Espiritualmente, es encontrar el "camino del medio", integrando tus luces y tus sombras para forjar un espíritu purificado, elevándote como un alquimista consciente.',
    meaningReversed:
      'Invertida revela excesos, desequilibrio químico o emocional, imprudencia, choque constante de fuerzas e impaciencia destructiva. El bloqueo es el comportamiento extremista, las adicciones o el desgaste energético por querer forzar los flujos naturales. Para superarlo, debes recuperar el control de tu biología y tus emociones, cortar con los hábitos destructivos y compulsivos, moderar tus reacciones e instaurar una rutina equilibrada de descanso, trabajo y paz mental.',
    description:
