...
export const SWORDS_EXTENDED_CONTENT: CardExtendedContentMap = {
  'ace-of-swords': {
    ...
    meaningWork:
      'Claridad mental y decisiones bien fundadas. Es la carta de la lectura certera de un problema laboral, del contrato que se firma, del argumento que convence. Muy favorable para exámenes, presentaciones, escritos y negociaciones donde gana quien piensa mejor. Suele señalar que tienes la información que necesitabas y que ahora corresponde actuar en consecuencia. En el dinero indica que los números por fin quedan a la vista: se acabaron las estimaciones y empieza la administración real.',
    meaningWellbeing:
    ...
    combinations: [
      {
        cardSlug: 'justice',
        reading:
          'La verdad se vuelve resolución formal. Aparece un fallo, un contrato o una decisión que zanja la discusión de manera definitiva. Prepara la documentación, porque acá se decide con pruebas y no con relatos.',
      },
      {
        cardSlug: 'the-tower',
        reading:
  ...
  'two-of-swords': {
    ...
    meaningWork:
      'Estancamiento por indecisión. Dos ofertas parecidas, dos caminos, un conflicto entre colegas donde te niegas a tomar partido. La carta describe el empate estratégico: mientras no decidas, no pierdes, pero tampoco avanzas. Suele aparecer cuando falta información y también cuando la información está y molesta. En el dinero indica cuentas que no quieres revisar. Poner los números sobre la mesa suele ser menos grave que la fantasía que estás sosteniendo por no mirarlos.',
    meaningWellbeing:
  ...
  'seven-of-swords': {
    ...
    meaningWork:
      'Alguien se está llevando algo: crédito por tu trabajo, información sensible, un cliente. También describe estrategias inteligentes pero poco transparentes, atajos y acuerdos que no se cuentan a todos. Es momento de proteger tus materiales, guardar respaldos y poner por escrito lo que se acordó de palabra. En el dinero indica movimientos poco claros, gastos que aparecen sin explicación o socios que manejan información que no comparten.',
    meaningWellbeing:
  ...
  'eight-of-swords': {
    ...
    combinations: [
      ...
      },
      {
        ...
        reading:
          'Una verdad corta las ataduras. Basta con nombrar la situación con precisión para que el encierro pierda fuerza: la claridad es acá la herramienta de rescate.',
      },
      {
        cardSlug: 'knight-of-wands',
        reading:
          'Aparece un impulso que rompe la parálisis. Alguien te empuja o te dan ganas de moverte de golpe: aprovecha ese envión antes de volver a pensarlo demasiado.',
      },
    ],
  },
  'nine-of-swords': {
    ...
    advice:
      'Sácalo de tu cabeza y ponelo afuera. Escribe lo que te está atormentando en una hoja, a la mañana, y separa lo que efectivamente pasó de lo que estás imaginando. Cuéntaselo a alguien de confianza aunque te dé pudor. Y si el problema es real, haz una sola cosa concreta hoy para atenderlo: la acción mínima ordena la noche mucho mejor que la voluntad.',
    yesNo:
    ...
    combinations: [
      {
        ...
        reading:
          'El miedo se concreta y toca el fondo. Duele, y a la vez termina la incertidumbre: a partir de acá lo que sigue es reconstruir sobre algo cierto.',
      },
      {
        cardSlug: 'the-sun',
        reading:
  ...
  'ten-of-swords': {
    ...
    meaningWellbeing:
      'El agotamiento llegó al límite: el cuerpo directamente no da más y lo está diciendo con claridad. Es momento de parar del todo y dejar que el descanso haga su trabajo, sin plan de recuperación acelerada. La energía va a volver, pero de a poco y desde abajo. Lo que corresponde ahora es lo elemental: dormir, comer, moverte apenas y dejar que pase el tiempo. No le pidas rendimiento a un cuerpo que acaba de tocar fondo.',
    symbolism:
  ...
  'page-of-swords': {
    ...
    yesNo:
      'Sí, con cautela y verificando. La respuesta es favorable si te tomas el trabajo de comprobar la información antes de avanzar sobre ella.',
    combinations: [
      {
        cardSlug: 'the-high-priestess',
        reading:
          'Estás investigando algo que se maneja en silencio. La información existe pero no está a la vista: escucha más de lo que preguntas y no fuerces las respuestas.',
      },
      {
        cardSlug: 'eight-of-wands',
        reading:
    ...
    combinations: [
      {
        ...
        reading:
          'Velocidad con dirección firme. Todo lo que necesite avanzar de golpe encuentra acá el envión perfecto: mudanzas que se resuelven, trámites trabados que se destraban y decisiones que venían durmiendo hace meses.',
      },
      {
  ...
  'king-of-swords': {
    ...
    combinations: [
      ...
      },
      {
        ...
        reading:
          'El exceso de análisis se volvió una jaula. Pensar más no va a resolverlo: la salida acá es un paso concreto, aunque no tengas todo calculado.',
      },
    ],
  },
};
