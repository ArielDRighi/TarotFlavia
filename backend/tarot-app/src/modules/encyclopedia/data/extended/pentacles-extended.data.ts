...
export const PENTACLES_EXTENDED_CONTENT: CardExtendedContentMap = {
  'ace-of-pentacles': {
    ...
    meaningWork:
      'Una oportunidad concreta con números reales: la oferta de trabajo, el cliente que llega, el capital inicial para arrancar. Es la mejor carta del mazo para empezar algo material, porque no promete: entrega. Suele venir con una propuesta que exige compromiso a largo plazo, y ahí está su condición. En el dinero señala un ingreso nuevo, una inversión que empieza bien o un ahorro que se convierte en herramienta. Lo que se planta ahora rinde si se lo trabaja con paciencia.',
    meaningWellbeing:
      'Buen momento para instalar un hábito y sostenerlo, porque la energía de esta carta es lenta y constante. Todo lo que empieces ahora tiene chances reales de durar: una rutina de movimiento, un horario de descanso, una manera más ordenada de comer. El cuerpo responde bien a la regularidad y mal a la exigencia repentina. Empieza chico y sin fecha de vencimiento: aquí el resultado viene del acumulado, no de la intensidad de la primera semana.',
    symbolism:
  ...
  'five-of-pentacles': {
    ...
    combinations: [
      ...
      },
      {
        cardSlug: 'the-sun',
        reading:
          'La intemperie se termina. Lo que faltaba vuelve a estar disponible y esta vez a la vista de todos: de las mejores continuaciones que puede tener una racha material complicada.',
      },
    ],
  },
  'six-of-pentacles': {
  ...
  'eight-of-pentacles': {
    ...
    meaningWork:
      'Oficio, práctica y perfeccionamiento. Aparece cuando estás aprendiendo algo en serio o repitiendo una tarea hasta dominarla. Es la carta del artesano, del que estudia, del que mejora su producto sin apuro. Muy favorable para capacitaciones, cambios de rubro con formación previa y trabajos donde la calidad importa más que la velocidad. En el dinero señala ingresos ganados con dedicación y en aumento gradual: cada mes un poco mejor que el anterior, sin saltos.',
    meaningWellbeing:
    ...
    yesNo:
      'Sí, con trabajo y dedicación. La respuesta es favorable siempre que estés dispuesto a poner las horas: aquí nada llega por suerte ni por atajo.',
    combinations: [
      {
        cardSlug: 'three-of-pentacles',
        reading:
  ...
  'nine-of-pentacles': {
    ...
    meaningWork:
      'Autonomía conseguida: trabajar por tu cuenta, manejar tus tiempos, cosechar lo que sembraste durante años. Es una carta de logro material bien merecido y sostenido con criterio. Suele aparecer cuando alguien alcanza estabilidad suficiente para elegir en qué trabaja y con quién. En materia de dinero, indica solvencia real, ahorros que rinden y capacidad de darte gustos sin desequilibrar nada. El aviso menor: cuida que la independencia no se convierta en no necesitar nunca a nadie.',
    meaningWellbeing:
      'Buena energía, buen descanso y una relación amable con el propio cuerpo. Es una etapa para disfrutar lo conseguido: rutinas que te gustan, tiempo al aire libre, placeres cuidados. El bienestar aquí viene de la autonomía, de manejar tus horarios y de no vivir corriendo. Sostén lo que ya funciona en vez de cambiarlo por algo más exigente. El ánimo es sereno y bien plantado: es de los mejores momentos del mazo para consolidar hábitos.',
    symbolism:
  ...
  'page-of-pentacles': {
    ...
    meaningWork:
      'Un aprendiz con futuro: alguien que empieza a estudiar, hace una pasantía o entra a un rubro nuevo con ganas de aprender bien. Es la carta de las oportunidades formativas y de los proyectos que arrancan en pequeño con proyección real. Muy favorable para volver a estudiar de grande. En lo económico, un ingreso inicial modesto que puede crecer si se lo trabaja: el primer cliente, la primera venta, el ahorro que empieza con poco y con método.',
    meaningWellbeing:
  ...
  'knight-of-pentacles': {
    ...
    advice:
      'Sostén el plan aunque los resultados tarden. Esta carta gana por acumulación: lo importante es no interrumpir. Revisa el método una vez y después dedícate a cumplirlo sin dramatismo. Y agenda un cambio chico cada tanto —una variación en la rutina, una idea nueva— para que la constancia no se convierta en piedra.',
    yesNo:
  ...
  'king-of-pentacles': {
    ...
    meaningWork:
      'Éxito material consolidado: el empresario, el profesional establecido, quien maneja recursos con criterio y genera trabajo para otros. Aparece cuando alcanzas una posición sólida o cuando alguien con poder económico te respalda. Excelente para inversiones, expansión de negocios y decisiones patrimoniales de largo plazo. En lo económico indica abundancia bien administrada y rendimientos estables. La contra es la rigidez: lo que funcionó veinte años no siempre funciona el año que viene.',
    meaningWellbeing:
