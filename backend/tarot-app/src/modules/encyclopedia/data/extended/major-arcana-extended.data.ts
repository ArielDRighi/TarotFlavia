...
export const MAJOR_ARCANA_EXTENDED_CONTENT: CardExtendedContentMap = {
  ...
  'the-magician': {
    ...
    meaningWork:
      'Tienes los recursos, las herramientas y el talento sobre la mesa: lo que falta es ponerlos a trabajar. Es una carta excelente para lanzamientos, presentaciones, ventas y todo lo que dependa de tu capacidad de comunicar valor. Suele aparecer cuando alguien subestima lo que ya sabe hacer. En el dinero indica que la mejora depende de una decisión tuya y no de un factor externo: los cuatro elementos ya están en el altar, falta que empieces.',
    meaningWellbeing:
  ...
  'the-high-priestess': {
    ...
    meaningWork:
      'Información que todavía no es pública, decisiones que se están tomando puertas adentro, un proyecto que conviene no anunciar. La Sacerdotisa aconseja observar y guardar silencio en lugar de mostrar todas las cartas. Es favorable para investigación, estudio, escritura y trabajos que requieren discreción. En el dinero indica que falta un dato importante: no firmes ni inviertas hasta tenerlo. Tu intuición sobre esa persona o esa propuesta suele estar acertando.',
    meaningWellbeing:
    ...
    combinations: [
      {
        ...
        reading:
          'Autoridad y solidez material en la misma escena. Todo lo que necesite fundarse con reglas claras y respaldo económico encuentra acá su mejor momento posible.',
      },
      {
        cardSlug: 'justice',
        reading:
  ...
  'the-hierophant': {
    ...
    meaningWork:
      'Instituciones, jerarquías y caminos formales: estudiar una carrera, obtener una certificación, entrar a una organización grande, respetar el procedimiento establecido. Es la carta del mentor y también del reglamento. Favorece todo lo académico, lo religioso, lo jurídico y lo tradicional. En el dinero indica ingresos estables dentro de una estructura conocida y decisiones conservadoras. Aconseja hacerlo por el canal oficial, aunque sea más lento que el atajo que estás considerando.',
    meaningWellbeing:
  ...
  'the-lovers': {
    ...
    advice:
      'Elige a conciencia y hacete cargo de lo que la elección deja afuera. Esta carta no admite la estrategia de esperar a que la decisión se tome sola: eso también es elegir, pero sin dirección. Pregúntate qué valor quieres que ordene esta etapa de tu vida y decide en función de eso, no de lo que sería más cómodo explicar.',
    yesNo:
  ...
  'the-chariot': {
    ...
    advice:
      'Toma las riendas y avanza en una sola dirección. Esta carta pide foco: elige un objetivo, ponle fecha y subordina el resto durante ese período. Las fuerzas que tirás para lados opuestos —el deseo y el deber, la prisa y el miedo— no se eliminan, se conducen. Y avisa a quienes viajan con ti hacia dónde estás yendo.',
    yesNo:
      'Sí, con esfuerzo y determinación. La respuesta es claramente favorable si tomás el control de la situación en lugar de esperar que se resuelva por su cuenta.',
    combinations: [
      {
      ...
      },
      {
        ...
        reading:
          'El impulso choca contra un proceso que no se puede apurar. Forzar acá alarga el trámite: suelta el control por un tramo y deja que madure.',
      },
    ],
  },
  strength: {
    ...
    meaningWork:
      'Se supera un obstáculo laboral con constancia y buen trato, no con imposición. Es una carta favorable para negociaciones difíciles, para manejar equipos complicados y para sostener un proyecto que exige aguante. Indica que tienes más fuerza de la que crees y que el camino es firme y sin estridencia. En el dinero marca recuperación gradual de una situación complicada, con disciplina y sin decisiones desesperadas. La paciencia acá rinde más que la audacia.',
    meaningWellbeing:
  ...
  'wheel-of-fortune': {
    ...
    meaningWork:
      'Un cambio de suerte que llega desde afuera: una oportunidad inesperada, un contexto que se mueve, un ciclo laboral que se cierra y otro que empieza. Es una carta favorable en general, con la advertencia de que la rueda sigue girando y ninguna posición es definitiva. En el dinero indica un giro en la situación económica, muchas veces a mejor. Aprovecha el momento alto sin creer que es permanente y guarda algo para cuando la rueda baje.',
    meaningWellbeing:
    ...
    symbolism:
      'Una rueda dorada gira en el cielo con las letras TARO —o ROTA, la rueda— alternadas con el tetragrámaton hebreo, y símbolos alquímicos en los radios. Tres criaturas la acompañan: una esfinge con espada arriba, un Tifón con cabeza de chacal bajando por la izquierda y una serpiente descendiendo por la derecha. En las cuatro esquinas, las figuras aladas de Tauro, Leo, Escorpio y Acuario leen libros: los signos fijos del zodíaco, lo estable que observa lo que cambia. Nadie empuja la rueda; gira sola.',
    advice:
    ...
    combinations: [
      ...
      },
      {
        ...
        reading:
          'La rueda estaba en su punto más bajo y a partir de acá sube. El golpe ya sucedió: lo que sigue, por definición de esta carta, es el movimiento ascendente.',
      },
      {
        cardSlug: 'the-hanged-man',
        reading:
      ...
      },
      {
        ...
        reading:
          'El cambio de suerte trae una chispa nueva. Aparece una oportunidad justo cuando el ciclo gira: agarrala rápido, porque esta ventana no se queda abierta.',
      },
    ],
  },
  justice: {
    ...
    meaningWork:
      'Contratos, trámites legales, evaluaciones y decisiones formales. Es la carta de los procesos donde se juzga con criterio y gana quien tiene los papeles en orden. Favorece juicios, acuerdos laborales, auditorías y todo lo que requiera transparencia. Indica que el resultado va a ser justo, aunque no necesariamente el que quieres. En el dinero marca cuentas que se ordenan, deudas que se saldan y decisiones económicas que hay que tomar con la cabeza fría.',
    meaningWellbeing:
    ...
    advice:
      'Haz lo correcto, aunque no sea lo más cómodo. Revisa qué parte de la situación te corresponde y asumila sin buscar culpables. Pon los papeles en orden, cumple lo que prometiste y di la verdad de manera completa. Lo que decidas ahora con criterio justo te va a ahorrar bastante más de lo que te cuesta hoy.',
    yesNo:
    ...
    combinations: [
      ...
      },
      {
        cardSlug: 'ten-of-pentacles',
        reading:
          'Sucesiones y división de bienes familiares que llegan a instancia formal. Lo que se defina ahora queda escrito y firmado: hacelo con asesoramiento profesional aunque haya toda la confianza del mundo.',
      },
      {
        cardSlug: 'the-devil',
        reading:
  ...
  'the-hanged-man': {
    ...
    combinations: [
      ...
      },
      {
        ...
        reading:
          'El impulso de avanzar choca con un proceso que no se acelera. Forzar acá alarga el trámite: guarda la energía para cuando el freno se levante, y va a levantarse.',
      },
      {
        cardSlug: 'judgement',
        reading:
  ...
  temperance: {
    ...
    meaningWork:
      'Colaboración fluida y equilibrio entre partes distintas: dos áreas que se coordinan, un acuerdo que combina intereses opuestos, un proyecto que necesita mezcla y no imposición. Es una carta favorable para mediaciones, trabajos en equipo y procesos largos donde la clave es el ritmo sostenido. En el dinero indica administración prudente y equilibrio entre lo que entra y lo que sale, sin decisiones extremas en ningún sentido.',
    meaningWellbeing:
      'Es la carta del equilibrio aplicado al cuerpo: dormir lo suficiente, moverte con moderación, comer sin extremos, alternar esfuerzo y descanso. Nada de planes drásticos: acá funciona la dosis correcta sostenida en el tiempo. Es un momento excelente para recuperarse de un desgaste, porque la energía vuelve gradualmente si no la exiges de golpe. El ánimo se estabiliza. La mezcla justa entre actividad y calma es literalmente lo que esta carta enseña.',
    symbolism:
  ...
  'the-devil': {
    ...
    meaningWork:
      'Un trabajo que te ata: buen sueldo y ningún sentido, un contrato que no puedes dejar, una sociedad que te conviene y te desgasta. También indica ambiciones que se volvieron obsesión y decisiones tomadas por miedo a perder estatus. En el dinero marca deudas, consumos que se escaparon de control y compromisos económicos que limitan tu libertad. Mira el número real de esa deuda: la mayor parte del peso viene de no querer mirarlo.',
    meaningWellbeing:
      'Hábitos que ya no controlas del todo: comer por ansiedad, dormir mal por pantallas, sostener rutinas que sabes que te restan. La carta no juzga el placer, marca la dependencia. Es un buen momento para identificar con precisión qué te está atando y empezar a aflojarlo, preferentemente con ayuda y no en soledad heroica. El ánimo mejora bastante en cuanto se nombra el problema, incluso antes de resolverlo del todo.',
    symbolism:
  ...
  'the-moon': {
    ...
    meaningWork:
      'Un panorama poco claro: propuestas con letra chica, socios que no muestran todo, un ambiente donde circulan versiones y ninguna se confirma. La carta aconseja no firmar ni decidir hasta tener datos duros. También indica trabajos vinculados a lo artístico y a lo simbólico, donde la ambigüedad es materia prima. En el dinero advierte sobre inversiones basadas en promesas: pide los números por escrito y espera a que se despeje la niebla.',
    meaningWellbeing:
      'El descanso se vuelve irregular y los sueños se hacen más vívidos e intensos. Es una etapa de sensibilidad alta donde los miedos crecen de noche y se achican de día. Ayuda mucho llevar un registro de lo que soñás y de lo que te inquieta, y también sostener horarios regulares para darle al cuerpo un marco estable. El ánimo fluctúa. No tomes decisiones importantes en los momentos bajos: espera a la mañana.',
    symbolism:
      'Una luna con rostro humano de perfil derrama trece rayos rectos y curvos sobre un paisaje nocturno, mientras quince yods caen del cielo. Abajo, un perro y un lobo aúllan hacia arriba: lo domesticado y lo salvaje reaccionando igual ante lo mismo. Un cangrejo emerge del estanque, lo que sube desde lo profundo. Entre dos torres grises, un sendero amarillo se pierde hacia las montañas del fondo. No hay figuras humanas. Todo el camino está iluminado apenas lo suficiente para no saber exactamente qué se está pisando.',
    advice:
    ...
    combinations: [
      ...
      },
      {
        ...
        reading:
          'Los miedos nocturnos se agrandan solos. Buena parte de lo que te atormenta no resiste la luz del día: escribilo a la mañana y vuelve a leerlo.',
      },
    ],
  },
  'the-sun': {
    ...
    meaningWork:
      'Éxito visible y reconocimiento: el proyecto que sale bien, la promoción, el examen aprobado, la etapa en la que todo lo que tocás funciona. Es una carta excelente para lanzamientos, presentaciones y comienzos. Indica claridad sobre lo que quieres hacer y energía suficiente para lograrlo. En el dinero marca una mejora concreta y sostenida, con abundancia que se disfruta. Aprovecha el momento alto para dejar armado lo que necesites cuando la racha baje.',
    meaningWellbeing:
  ...
  'the-world': {
    ...
    advice:
      'Cierra bien lo que estás terminando antes de correr a lo siguiente. Agradece, despídete de quien corresponda, entrega lo que quedaba pendiente y date el gusto de reconocer todo lo que hiciste para llegar hasta acá. Y después pregúntate qué quieres que empiece: esta carta es una puerta, y si la dejas cerrada demasiado tiempo, la plenitud se vuelve nostalgia.',
    yesNo:
    ...
    combinations: [
      {
        cardSlug: 'the-fool',
        reading:
          'El final toca el comienzo. Un ciclo se cierra completo y otro arranca en el mismo movimiento: suele marcar viajes, mudanzas y etapas de vida que cambian por entero.',
      },
      {
