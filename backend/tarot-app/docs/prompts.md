...
Si la tarea incluye crear migraciones, evaluar agregarla al archivo de migración existente 1761655973524-InitialSchema, ya que aún la aplicación no se encuentra en producción y esto ayuda a mantener un historial de migraciones limpio.
